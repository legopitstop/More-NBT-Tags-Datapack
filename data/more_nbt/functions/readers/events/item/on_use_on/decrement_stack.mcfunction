...
execute if entity @p[nbt={SelectedItem:{tag:{on_use_on:{decrement_stack:{}}}}}] run item entity @p[gamemode=!creative] weapon.mainhand modify more_nbt:item/decrement_stack
execute if entity @p[nbt={SelectedItem:{tag:{on_use_on:{decrement_stack:{ignore_game_mode:true}}}}}] run item entity @p weapon.mainhand modify more_nbt:item/decrement_stack
# reset
