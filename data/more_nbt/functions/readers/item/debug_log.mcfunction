...
#  Have plans to make a better way to deal with the debuglog. That includes using a storage that contains a customizeable schema.

# food

# foil
execute if entity @p[nbt={SelectedItem:{tag:{moreNBT:{},foil: true}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"added glint to item.","color":"white"}]
...
# add_mob_effect
execute if entity @p[scores={used.item=1..},nbt={SelectedItem:{tag:{on_use:{add_mob_effect:{}}}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"Expected an array","color":"red"}]
execute if entity @p[scores={used.item=1..},nbt={SelectedItem:{tag:{on_hold:{add_mob_effect:{}}}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"Expected an array","color":"red"}]
execute if entity @p[scores={used.item=1..},nbt={SelectedItem:{tag:{on_use_on:{add_mob_effect:{}}}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"Expected an array","color":"red"}]
...
# remove_mob_effect
execute if entity @p[scores={used.item=1..},nbt={SelectedItem:{tag:{on_use:{remove_mob_effect:{}}}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"Expected an array","color":"red"}]
execute if entity @p[scores={used.item=1..},nbt={SelectedItem:{tag:{on_hold:{remove_mob_effect:{}}}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"Expected an array","color":"red"}]
execute if entity @p[scores={used.item=1..},nbt={SelectedItem:{tag:{on_use_on:{remove_mob_effect:{}}}}}] run tellraw @p ["",{"translate":"[DebugLog] ","color":"gray","bold":true},{"translate":"Expected an array","color":"red"}]
